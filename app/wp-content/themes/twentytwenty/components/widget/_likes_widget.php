  ...
  function get_likes_widget(WP_Post $post): string
  {
    ...
    return '
      <div class="likes_widget" data-post-id="'.$post->ID.'">
        <button class="button decrement" data-type="decrement" '.($type === '-1' ? 'disabled' : '' ).' aria-label="Decrement">
        ...
        <button class="button increment" data-type="increment" '.($type === '1' ? 'disabled' : '' ).' aria-label="Increment">
